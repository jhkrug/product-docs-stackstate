...
image::/.gitbook/assets/k8s/k8s-quick-start-menu.png[Main menu]
...
image::/.gitbook/assets/k8s/k8s-quick-start-services.png[Services overview]
...
image::/.gitbook/assets/k8s/k8s-quick-start-service-topology.png[Services topology]
...
image::/.gitbook/assets/k8s/k8s-quick-start-service.png[Service overview]
...
image::/.gitbook/assets/k8s/k8s-quick-start-service-5xx-error-triggered-monitor.png[HTTP - 5xx error ratio triggered monitor]
