...
image::../../.gitbook/assets/k8s/k8s-filters.png[View filters]
...
image::../../.gitbook/assets/k8s/k8s-filters-kube-topology.png[Kubernetes topology filters]
...
image::../../.gitbook/assets/k8s/k8s-filters-basic-topology.png[Basic topology filters]
...
image::../../.gitbook/assets/k8s/k8s-filters-advanced-topology.png[Advanced topology filters]
...
image::../../.gitbook/assets/k8s/k8s-filters-events.png[Events filters]
