...
image::../../.gitbook/assets/k8s/k8s-overview-perspective-table-comparison.png[Overview table structure comparison]
...
image::../../.gitbook/assets/k8s/k8s-overview-perspective-generic-table.png[Overview table generic structure]
...
image::../../.gitbook/assets/k8s/k8s-overview-perspective-cards-layout.png[Overview cards layout]
