...
image::../../.gitbook/assets/k8s/k8s-traces-perspective.png[Traces perspective]
...
In SUSE Observability, a xref:k8s-view-structure.adoc[view] shows you a sub-selection of your IT infrastructure for a particular Kubernetes resource.
...
image::../../.gitbook/assets/k8s/k8s-traces-perspective-span-details.png[A descendant span details]
...
When using the Traces Perspective, just like in other perspectives, you can either be in live mode or link:../stackstate-ui/k8sTs-timeline-time-travel.adoc#time-travel[time travel to the past].
