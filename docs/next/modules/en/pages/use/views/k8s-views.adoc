...
image::../../.gitbook/assets/k8s/k8s-menu.png[Kubernetes views]
...
image::../../.gitbook/assets/k8s/k8s-service-overview.png[Overview pages]
...
image::../../.gitbook/assets/k8s/k8s-pod-highlights.png[Highlights pages]
