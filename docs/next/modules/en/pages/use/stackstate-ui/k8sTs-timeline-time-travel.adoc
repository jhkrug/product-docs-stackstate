...
image::../../.gitbook/assets/k8s/k8s-timeline.png[Timeline]
...
image::../../.gitbook/assets/v51_telemetry_interval.png[Telemetry interval]
...
image::../../.gitbook/assets/v51_timeline_click_drag.png[Click and drag on the timeline to set a custom telemetry interval on your selection]

* *Zoom out*

image::../../.gitbook/assets/v51_telemetry_interval_zoom_out.png[Click the magnifying glass to double the size of the telemetry interval]

* *Use the telemetry interval jumper arrows*

image::../../.gitbook/assets/v51_telemetry_interval_jumper.png[Click the time jumper arrows to move the telemetry interval backwards or forwards through time]

* *Set a relative or custom telemetry interval*

image::../../.gitbook/assets/v51_timeline_telemetry_interval.png[Use the popup "Set the telemetry interval" to specify a telemetry interval]
...
image::../../.gitbook/assets/v51_topology_time.png[Topology time]
...
image::../../.gitbook/assets/v51_topology_time_timeline.png[Click anywhere on the timeline to set the topology time to that moment]

* *Use the topology time jumper arrows*

image::../../.gitbook/assets/v51_topology_time_jumper.png[Click the topology time jumper arrows to move the topology time backwards or forwards in time to the next set of events]

* *Set a custom topology time*

image::../../.gitbook/assets/v51_topology_time_popup.png[Use the popup "Set the topology time" to specify a topology time]

* *Click a timestamp*

image::../../.gitbook/assets/v51_topology_time_timestamp.png[Click a timestamp to jump to that specific topology time]
...
image::/.gitbook/assets/v51_topology_time_outside_telemetry_interval.png[Topology time outside telemetry interval]
...
image::../../.gitbook/assets/v51_timeline_go_live.png[Go live]
...
image::../../.gitbook/assets/v51_timeline_no_health_state.png[Health state not available]
...
image::../../.gitbook/assets/v51_timeline_click_drag.png[Click and drag to select a telemetry interval]
