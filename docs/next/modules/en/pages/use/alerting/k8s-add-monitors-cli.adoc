...
image::../../.gitbook/assets/k8s/available-replicas-metric-inspector.png[The available replicas in the metric explorer]
...
image::../../.gitbook/assets/k8s/component-identifier.png[Finding a component identifier]
