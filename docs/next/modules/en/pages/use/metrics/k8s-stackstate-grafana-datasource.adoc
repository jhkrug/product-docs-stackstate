...
image::../../.gitbook/assets/k8s/k8s-grafana-new-datasource.png[Grafana new datasource]
...
image::../../.gitbook/assets/k8s/k8s-grafana-datasource.png[Grafana datasource configuration]
