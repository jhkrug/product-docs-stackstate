...
image::../../.gitbook/assets/k8s/k8s-prometheus-remotewrite.png[Prometheus Remote Write]
...
+
image::../../.gitbook/assets/k8s/k8s-stackpacks.png[StackPacks]
...
+
image::../../.gitbook/assets/k8s/k8s-stackpacks-apikey.png[API Key]
