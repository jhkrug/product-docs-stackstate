...
image::../../.gitbook/assets/k8s/k8s-menu.png[Kubernetes Paradigms Menu]
...
image::../../.gitbook/assets/k8s/k8s-pod-view-node-agent.png[Kubernetes Pod View]
...
image::../../.gitbook/assets/k8s/k8s-pod-view-log-drawer-no-filter.png[Kubernetes Log View No Filters]
...
image::../../.gitbook/assets/k8s/k8s-pod-view-log-drawer-with-filters.png[Kubernetes Log View With Filters]
