...
image::/.gitbook/assets/k8s/prime/SUSEObservabilityDeployment.png[Architecture]
...
image::/.gitbook/assets/k8s/prime/rancher_cluster_dashboard.png[Rancher]
...
image::/.gitbook/assets/k8s/prime/ui_extensions.png[Install]
